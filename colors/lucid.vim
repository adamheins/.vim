...
let colorgroup['ColorColumn']  = {"GUIFG": _rock_dark, "GUIBG":  _gray_dark}
let colorgroup['Conceal']      = {"GUIFG": _sap,        "GUI": "bold"}
" let colorgroup['Cursor']       = {"GUIFG": _rock_dark, "GUIBG":  _turquoise}
let colorgroup['CursorLine']   = {                     "GUIBG":  _gray_dark}
...
let colorgroup['Search']       = {"GUIFG": _cloud,     "GUIBG":  _turquoise, "GUI": "underline"}
